...
`// CORS res.setHeader("Access-Control-Allow-Origin", "*"); res.setHeader("Access-Control-Allow-Methods", "GET,HEAD,PUT,POST,DELETE,PATCH,OPTIONS"); res.setHeader("Access-Control-Allow-Headers", "Content-Type, Authorization"); // Cache res.setHeader("Cache-Control", "max-age=300, must-revalidate"); // Cookie res.setHeader("Set-Cookie", "token=123; HttpOnly; SameSite=Strict; Max-Age=3600; Path=/; Secure;");`
...
application/jsonCopiar

`// Content-Type -> JSON res.setHeader("Content-Type", "application/json"); return res.end(JSON.stringify({ user: "origamid" }));`

text/htmlCopiar

``// Content-Type -> HTML res.setHeader("Content-Type", "text/html; charset=utf-8"); const curso = "Node.js"; return res.end(`<html>   <head>     <title>Curso de ${curso}$</title>   </head>   <body>     <h1>Curso de ${curso}$</h1>   </body> </html>`);``
